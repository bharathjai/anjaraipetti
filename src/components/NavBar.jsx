  ...
  return (
    ...
    >
      <div className="mx-auto flex w-full max-w-7xl items-center justify-between px-6 py-4 md:px-10">
        <NavLink to="/" className="inline-flex items-center gap-3 px-2 py-1">
          <BoilingCooktop />
          <span className="relative isolate">
            <span aria-hidden="true" className="pointer-events-none absolute -left-6 -top-5 h-14 w-44 opacity-45">
              <BrandHatMark />
            </span>
        ...
        <div className="flex items-center gap-3">
          ...
          {links.map((link) => (
            <NavLink
              ...
              to={link.to}
              className={({ isActive }) =>
                `btn-hover rounded-full px-4 py-2 text-sm font-semibold transition ${
